...
//            intent_name.setClass(context.getApplicationContext(),.class);
...
//            dialog.setMessage("");
    ...
    protected String doInBackground(String... voids) {
        ...
        String connstr = "http://192.168.0.103:8080/Web-Engineering/connection.php";

//        String connstr = "https://waterplant.000webhostapp.com/android.php";
